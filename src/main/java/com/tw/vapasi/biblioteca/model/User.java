...
public class User {
    ...
    public  void addCheckoutBook(Book book) throws BookAlreadyCheckoutException {
        if (checkoutBooks.contains(book)) {
            throw new BookAlreadyCheckoutException(book.getBookName());
        }
        checkoutBooks.add(book);
    }

    public void returnBook(Book book) throws BooksNotReturnedException {
        if(!checkoutBooks.contains(book)){
            throw new BooksNotReturnedException(book.getBookName());
        }
